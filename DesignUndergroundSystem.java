...
class UndergroundSystem {
    Map<Integer, Pair<String, Integer>> checkedIn = new HashMap<>(); 
    Map<Pair<String, String>, int[]> stations = new HashMap<>(); 
    ...
    public void checkOut(int id, String endStation, int t2) {
        String startStation = checkedIn.get(id).getKey();
        int t1 = checkedIn.get(id).getValue();
        Pair<String, String> pair = new Pair<>(startStation, endStation);
        int[] tc = stations.computeIfAbsent(pair, k -> new int[2]);
        tc[0] += 1; 
        tc[1] += t2-t1; 
        checkedIn.remove(id);
    }
    ...
    public double getAverageTime(String startStation, String endStation) {
        Pair<String, String> pair = new Pair<>(startStation, endStation);
        int[] tc = stations.get(pair);
        return (double) tc[1] / tc[0]; 
    }
}
